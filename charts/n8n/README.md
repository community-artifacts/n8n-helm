...
For usage instructions, configuration options, and additional information about this Helm chart, see the values reference below and the example sections in this document. For n8n itself, refer to the [n8n documentation](https://docs.n8n.io/).
...
| Name | Email | Url |
| ---- | ------ | --- |
| community-artifacts | | <https://github.com/community-artifacts> |
